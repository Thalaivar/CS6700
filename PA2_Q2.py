...
def run_test():
	...
	for i in range(2000):
		...
		task_rewards, opt_action_choose = run_task(mu, var)
...
def main():
	...
	eps_greedy_policy_avg_001, _, opt_choose_1 = run_test()
	eps_greedy_policy_avg_01, _, opt_choose_2 = run_test()
	eps_greedy_policy_avg_05, _, opt_choose_3 = run_test()
